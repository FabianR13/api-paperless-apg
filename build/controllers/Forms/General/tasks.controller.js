...
const Minuta = require("../../../models/General/Minuta.js"); //Metodo para tener las tareas
...
const createNewTask = async (req, res) => {
  try {
    ...
    newTask.minuta = [minutaId]; // Calcular el valor de item según las tareas ya existentes para esta minuta

    const tareasRelacionadas = await Tasks.find({
      minuta: minutaId
    }).sort({
      item: -1
    }).limit(1);
