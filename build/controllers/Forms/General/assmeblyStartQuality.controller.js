...
const DeviationRequest = require("../../../models/General/DeviationRequest.js"); //method to post assemblystar quality/////////////////////////////////////////////////////////////////////////////////
...
const createAssemblyStartQuality = async (req, res) => {
  ...
  if (!numberDevitaion) {
    return res.json({
      status: "403",
      message: "number deviation not in here",
      body: ""
    });
  }
  ...
  res.json({
    status: "200",
    message: "Assembly Quality created",
    savedAssemblyStartQuality
  });
}; //method to update///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
const updateAssemblyStartQuality = async (req, res) => {
  ...
  if (!req.body.numberDevitaion) {
    return res.json({
      status: "403",
      message: "the number deviation is empty",
      body: ""
    });
  }
  ...
  if (foundDeviationRequest.length === 0) {
    return res.json({
      status: "403",
      message: "not number deviation founded",
      body: ""
    });
  }
  ...
  if (!updatedAssemblyStartQuality) {
    res.status(403).json({
      status: "403",
      message: "assembly quality not updated",
      body: ""
    });
  }
  ...
  res.status(200).json({
    status: "200",
    message: "assembly quality updated",
    body: updatedAssemblyStartQuality
  });
}; //method to get/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
const getAssemblyStartQuality = async (req, res) => {
  ...
  res.json({
    status: "200",
    message: "assembly quality loaded",
    body: assemblyStartQuality
  });
};
