...
const User = require("../models/User.js"); //mehtod to post ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
const createAssemblyStartProduction = async (req, res) => {
  ...
  res.json({
    status: "200",
    message: "assembly production created",
    savedAssemblyStartProduction
  });
}; //method to update /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
const updateAssemblyStartProduction = async (req, res) => {
  ...
  if (!updatedAssemblyStartProduction) {
    res.status(403).json({
      status: "403",
      message: "assembly production not updated",
      body: ""
    });
  }
  ...
  res.status(200).json({
    status: "200",
    message: "assembly production updated",
    body: updatedAssemblyStartProduction
  });
}; //method to get //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
const getAssemblyStartProduction = async (req, res) => {
  ...
  res.json({
    status: "200",
    message: "assembly production loaded",
    body: assemblyStartProduction
  });
};
