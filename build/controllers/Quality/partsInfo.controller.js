const PartsInfo = require("../../models/Quality/PartsInfo.js"); //Create new part info///////////////////////////////////////////////////////////////////////////////////////////////////
...
const updatePartInfo = async (req, res) => {
  ...
  res.status(200).json({
    stauts: "200",
    message: "part info updated",
    body: updatedPartInfo
  });
};
