...
const EndRun = require("../models/EndRun.js");

const User = require("../models/User.js"); //method to post endrun//////////////////////////////////////////////////////////////////////////////////////////////
...
const updateEndRun = async (req, res) => {
  ...
  if (!req.body.employeeT) {
    return res.json({
      status: "403",
      message: "the employeeT is empty",
      body: ""
    });
  }
  ...
  if (!req.body.employeeQ) {
    return res.json({
      status: "403",
      message: "the employeeQ is empty",
      body: ""
    });
  }
  ...
  if (!req.body.employeeP) {
    return res.json({
      status: "403",
      message: "the employeeP is empty",
      body: ""
    });
  }
  ...
  if (!updatedEndRun) {
    res.status(403).json({
      status: "403",
      message: "change mold not updated",
      body: ""
    });
  }
